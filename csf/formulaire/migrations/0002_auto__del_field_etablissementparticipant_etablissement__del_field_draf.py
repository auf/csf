...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EtablissementParticipant.etablissement'
        db.delete_column('formulaire_etablissementparticipant', 'etablissement_id')

        # Deleting field 'DraftEtablissementParticipant.etablissement'
        db.delete_column('formulaire_draftetablissementparticipant', 'etablissement_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'EtablissementParticipant.etablissement'
        raise RuntimeError("Cannot reverse this migration. 'EtablissementParticipant.etablissement' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DraftEtablissementParticipant.etablissement'
        raise RuntimeError("Cannot reverse this migration. 'DraftEtablissementParticipant.etablissement' and its values cannot be restored.")
