...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EtablissementEligible.participant'
        db.alter_column('formulaire_etablissementeligible', 'participant', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):

        # Changing field 'EtablissementEligible.participant'
        db.alter_column('formulaire_etablissementeligible', 'participant', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        'formulaire.etablissementeligible': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'participant': ('django.db.models.fields.NullBooleanField', [], {'default': 'False', 'null': 'True', 'blank': 'True'}),
