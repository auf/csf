...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OffreFormation.offert'
        db.add_column('formulaire_offreformation', 'offert',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DraftOffreFormation.offert'
        db.add_column('formulaire_draftoffreformation', 'offert',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OffreFormation.offert'
        db.delete_column('formulaire_offreformation', 'offert')

        # Deleting field 'DraftOffreFormation.offert'
        db.delete_column('formulaire_draftoffreformation', 'offert')
