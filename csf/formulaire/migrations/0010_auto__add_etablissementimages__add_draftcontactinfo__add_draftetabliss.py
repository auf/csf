...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EtablissementImages'
        db.create_table('formulaire_etablissementimages', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('etablissement', self.gf('django.db.models.fields.related.OneToOneField')(related_name='images', unique=True, to=orm['formulaire.EtablissementEligible'])),
        ))
        db.send_create_signal('formulaire', ['EtablissementImages'])

        # Adding model 'DraftContactInfo'
        db.create_table('formulaire_draftcontactinfo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('page_personnelle', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
            ('etablissement', self.gf('django.db.models.fields.related.OneToOneField')(related_name='draft_contact_info', unique=True, to=orm['formulaire.EtablissementEligible'])),
        ))
        db.send_create_signal('formulaire', ['DraftContactInfo'])

        # Adding model 'DraftEtablissementImages'
        db.create_table('formulaire_draftetablissementimages', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('etablissement', self.gf('django.db.models.fields.related.OneToOneField')(related_name='draft_images', unique=True, to=orm['formulaire.EtablissementEligible'])),
        ))
        db.send_create_signal('formulaire', ['DraftEtablissementImages'])

        # Deleting field 'EtablissementEligible.photo'
        db.delete_column('formulaire_etablissementeligible', 'photo')

        # Deleting field 'EtablissementEligible.logo'
        db.delete_column('formulaire_etablissementeligible', 'logo')


    def backwards(self, orm):
        # Deleting model 'EtablissementImages'
        db.delete_table('formulaire_etablissementimages')

        # Deleting model 'DraftContactInfo'
        db.delete_table('formulaire_draftcontactinfo')

        # Deleting model 'DraftEtablissementImages'
        db.delete_table('formulaire_draftetablissementimages')

        # Adding field 'EtablissementEligible.photo'
        db.add_column('formulaire_etablissementeligible', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EtablissementEligible.logo'
        db.add_column('formulaire_etablissementeligible', 'logo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        'formulaire.draftcontactinfo': {
            'Meta': {'object_name': 'DraftContactInfo'},
            'courriel': ('django.db.models.fields.EmailField', [], {'max_length': '75', 'null': 'True', 'blank': 'True'}),
            'etablissement': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'draft_contact_info'", 'unique': 'True', 'to': "orm['formulaire.EtablissementEligible']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'page_personnelle': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'prenom': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
        ...
        'formulaire.draftetablissementimages': {
            'Meta': {'object_name': 'DraftEtablissementImages'},
            'etablissement': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'draft_images'", 'unique': 'True', 'to': "orm['formulaire.EtablissementEligible']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'formulaire.etablissementimages': {
            'Meta': {'object_name': 'EtablissementImages'},
            'etablissement': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'images'", 'unique': 'True', 'to': "orm['formulaire.EtablissementEligible']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'photo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
