...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EtablissementEligible.user'
        db.add_column('formulaire_etablissementeligible', 'user',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['auth.User'], unique=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EtablissementEligible.user'
        db.delete_column('formulaire_etablissementeligible', 'user_id')
