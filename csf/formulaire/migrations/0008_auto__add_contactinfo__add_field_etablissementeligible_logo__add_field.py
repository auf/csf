...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('formulaire_contactinfo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('etablissement', self.gf('django.db.models.fields.related.OneToOneField')(related_name='contact_info', unique=True, to=orm['formulaire.EtablissementEligible'])),
        ...
        db.send_create_signal('formulaire', ['ContactInfo'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('formulaire_contactinfo')
