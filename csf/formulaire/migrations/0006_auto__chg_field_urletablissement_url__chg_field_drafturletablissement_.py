...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'URLEtablissement.url'
        db.alter_column('formulaire_urletablissement', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

        # Changing field 'DraftURLEtablissement.url'
        db.alter_column('formulaire_drafturletablissement', 'url', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'URLEtablissement.url'
        raise RuntimeError("Cannot reverse this migration. 'URLEtablissement.url' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DraftURLEtablissement.url'
        raise RuntimeError("Cannot reverse this migration. 'DraftURLEtablissement.url' and its values cannot be restored.")
