...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OffreFormation.etablissement'
        db.alter_column('formulaire_offreformation', 'etablissement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['formulaire.EtablissementEligible']))

        # Changing field 'URLEtablissement.etablissement'
        db.alter_column('formulaire_urletablissement', 'etablissement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['formulaire.EtablissementEligible']))
        # Adding field 'EtablissementEligible.participant'
        db.add_column('formulaire_etablissementeligible', 'participant',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'DraftOffreFormation.etablissement'
        db.alter_column('formulaire_draftoffreformation', 'etablissement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['formulaire.EtablissementEligible']))

        # Changing field 'DraftURLEtablissement.etablissement'
        db.alter_column('formulaire_drafturletablissement', 'etablissement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['formulaire.EtablissementEligible']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'OffreFormation.etablissement'
        db.alter_column('formulaire_offreformation', 'etablissement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['formulaire.EtablissementParticipant']))

        # Changing field 'URLEtablissement.etablissement'
        db.alter_column('formulaire_urletablissement', 'etablissement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['formulaire.EtablissementParticipant']))
        # Deleting field 'EtablissementEligible.participant'
        db.delete_column('formulaire_etablissementeligible', 'participant')


        # Changing field 'DraftOffreFormation.etablissement'
        db.alter_column('formulaire_draftoffreformation', 'etablissement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['formulaire.DraftEtablissementParticipant']))

        # Changing field 'DraftURLEtablissement.etablissement'
        db.alter_column('formulaire_drafturletablissement', 'etablissement_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['formulaire.DraftEtablissementParticipant']))
